import { ImportAnimationsAsync, ImportMeshAsync, LoadAssetContainerAsync } from "../Loading/sceneLoader.js";
...
export class ContainerAssetTask extends AbstractAssetTask {
     ...
     */
    runTask(scene, onSuccess, onError) {
        LoadAssetContainerAsync(this.rootUrl + "/" + this.sceneFilename.toString(), scene, {
...
export class MeshAssetTask extends AbstractAssetTask {
     ...
     */
    runTask(scene, onSuccess, onError) {
        ImportMeshAsync(this.rootUrl + "/" + this.sceneFilename, scene, {
            meshNames: this.meshesNames,
            pluginExtension: this.extension,
        }).then(({ meshes, particleSystems, skeletons, animationGroups, transformNodes }) => {
...
export class AnimationAssetTask extends AbstractAssetTask {
    ...
    runTask(scene, onSuccess, onError) {
        ...
        ImportAnimationsAsync(this.rootUrl + "/" + this.filename, scene, {
            pluginExtension: this.extension,
